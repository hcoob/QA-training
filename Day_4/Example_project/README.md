Overview:
Create an API which will be access by external public health authorities to retrieve patient test results.

Functionalities/Features:
- Users can securely connect to the API
...
Sprint_4
1. Manage authorisation/authentication
2. UAT
